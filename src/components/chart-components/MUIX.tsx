    ...
    <>
      ...
      <div className='chart-container' style={{ float: 'left' }}>
        ...
        <PieChart
            ...
            height={300}
        />
        <p>* Тут надо много данных дать для красоты и работоспособности, просто показал возможность</p>
      </div>
      ...
      <ul>
        <li>
          Много возможностей для кастомизации бувально всего
        </li>
        <li>
          Возможность задавать обработчики событий
        </li>
        <li>
          Можно довольно сложные диаграммы из больших наборов датасетов
        </li>
        <li>
          Встроенная анимация
        </li>
