  ...
  return (
    <>
      <p>
        ...
        По факту библиотека не самая удобная: у них есть общий компонент <b>Chart</b>, в который передаётся огромный объект конфига.
        Даже в низкоуровневой react-chartjs-2, который является по-сути Chart.js для React, 
        для создания графика <b>не надо создавать отдельный файл с объявлением конфига на 170+ строк</b>.
        При этом если обернуть объект Chart в обычный div, то он сжимается до высоты в 1 пиксель (ширина на весь экран).
        Для "обёртки" графика надо создавать отдельный компонент.
