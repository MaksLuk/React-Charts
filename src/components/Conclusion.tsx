function Conclusion() {
  ...
  return (
    <>
      ...
      <ul>
        <li>
          <b>react-chartkick</b> - высокоуровневая не перенасыщенная функционалом библиотека,
        ...
        <li>
          <b>D3</b> - библиотека не была рассмотрена детально; судя по примерам больше подходит для визуализции больших объемов данных,
